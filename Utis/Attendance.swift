...
@objc open class RPicker: NSObject {
    ...
    @objc class func selectDate(title: String? = nil,
        ...
        vc.onDateSelected = { selectedData in didSelectDate?(selectedData) }
    }
    ...
    class func selectOption(title: String? = nil,
        ...
        guard let arr = dataArray,
              let vc = controller(title: title, cancelText: cancelText, doneText: doneText, dataArray: arr, selectedIndex: selectedIndex, type: .option) else { return }
    ...
    @objc class func pickOption(title: String? = nil,
        ...
        guard let arr = dataArray,
              let vc = controller(title: title, cancelText: cancelText, doneText: doneText, dataArray: arr, selectedIndex: selIndex, type: .option) else { return }
        vc.onOptionSelected = { selectedValue, selectedIndex in
            didSelectValue?(selectedValue, selectedIndex)
        }
    }
