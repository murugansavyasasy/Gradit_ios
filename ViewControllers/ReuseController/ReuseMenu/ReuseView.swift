...
if priority == "p4"{
    ...
    print("stu",MenuRefName.count)
    return MenuRefName.count
}

else if priority == "p1"{
    
    print("Prinadadcasdx",MenuRefName.count)
    return MenuRefName.count
    ...
    print("father",MenuRefName.count)
    return MenuRefName.count
    ...
    print("NonTeaching",MenuRefName.count)
    return MenuRefName.count
